...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    // 1. Find appointments for a doctor within a time range
    ...
    // 2. Find appointments by doctor ID, patient name (case-insensitive), and time range
    ...
    // 5. Find all appointments for a patient by status, ordered by appointment time
